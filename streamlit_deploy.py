...
<style>
    ...
    @keyframes dynamicSweep {
        0% { background-position: 0% 0%; }
        50% { background-position: 100% 100%; }
        100% { background-position: 0% 0%; }
    }

    /* Intense interactive sweeping geometric lines */
    .stApp {
        background-color: #03040a;
        background-image: 
            repeating-radial-gradient(circle at center, transparent 0, transparent 35px, rgba(121, 40, 202, 0.5) 36px, transparent 38px),
            repeating-radial-gradient(circle at center, transparent 0, transparent 80px, rgba(255, 0, 127, 0.6) 81px, transparent 84px),
...
<div class="hero-header" style="margin-bottom: 0px;">
    <h1>Intelligence That<br>Never Sleeps.</h1>
    <p>
